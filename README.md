...
- En tenis, cuando un partido finaliza sin tanteo numérico en el feed principal (p. ej. walkover), se enriquece el evento desde feeds de detalle y se muestra el estado final en el título.
